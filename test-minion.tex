...
%% utf8math.el
%% ("/plgeq" ?⩾)  ; U+2A7D  #xE2 #xA9 #xBD
%% ("/plleq" ?⩽)  ; U+2A7E  #xE2 #xA9 #xBE 

\section {\bf 10}\quad Przerwa na matematykę

$$
      \sum_{i=1}^{n} i \xle {n(n+1)\over 2}
$$
$$
      \det \left[\matrix{1&2&3\cr4&5&6\cr7&8&9\cr}\right] ⩽ 16
$$
$$
...
\section {\bf 12}\quad Opowiadania Paszeka
